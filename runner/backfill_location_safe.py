#!/usr/bin/env python3
"""
Backfill company location with frequent commits and global socket timeout.
...
# Set global socket timeout to prevent SSL handshake hangs
